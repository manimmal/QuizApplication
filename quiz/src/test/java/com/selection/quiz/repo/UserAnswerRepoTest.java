...
public class UserAnswerRepoTest {
    ...
    @Test
    public void retrieveSecondQuestion() throws Exception {
    	UserAnswer answer = new UserAnswer();
    	answer.setAid(1);
    	answer.setOrderNum(1);
    	answer.setQid(1);
    	answer.setUid(1);
    	Mockito.when(userAnswerRepo.retrieveSecondQuestion(answer.getUid(), answer.getOrderNum())).thenReturn(answer);
    	UserAnswer answer2 = userAnswerRepo.retrieveSecondQuestion(answer.getUid(), answer.getOrderNum());
    	Assert.assertTrue(answer.getQid() == answer2.getUid());
    }
